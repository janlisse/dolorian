...
object WorkItems extends Controller with Secured {
  ...
  def export = withAuth {
    username => implicit request =>
      ...
      val caption = new Paragraph(new Chunk("Leistungserfassung", font))
      val customerLine = new Paragraph(new Chunk("Auftragnehmer:", defaultFont))
      val projectLine = new Paragraph(new Chunk("Projektnummer:", defaultFont))
      ...
      table.setWidths(Array(10f, 10f, 30f))
